...
public class MaxMin_BinaryTree {
    ...
    public static Pair<Integer, Integer> getMinAndMax(BinaryTreeNode<Integer> root) {
        ...
        getMinAndMax_helper(root);
        return maxMin;
    }

    private static void getMinAndMax_helper(BinaryTreeNode<Integer> root) {
        if (root == null) {
            return;
        }
        ...
        getMinAndMax_helper(root.left);
        getMinAndMax_helper(root.right);
    }
