/*
Problem statement
Given a binary search tree and an integer S, find a pair of nodes in the BST which sum to S. You can use extra space of the order of O(log n).
