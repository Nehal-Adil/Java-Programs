...
public class InsertNode_LL {

    static CN_Node<Integer> insert(CN_Node<Integer> head, int elem, int pos) {
        CN_Node<Integer> nodeToBeInserted = new CN_Node<>(elem);
