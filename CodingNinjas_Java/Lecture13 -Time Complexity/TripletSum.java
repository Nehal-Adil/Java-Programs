...
public class TripletSum {
    ...
    // Time complexity for the below function is O(n^3) which is really bad
    // and this will also exceed Time Limit for some Test cases
    ...
    public static int findTriplet_02(int[] arr, int num) {
        Arrays.sort(arr);
        int n = arr.length;
    ...
    public static void main(String[] args) {
        ...
        while (t > 0) {
            ...
            int x = sr.nextInt();
            System.out.println((TripletSum.findTriplet_02(arr, x)));
