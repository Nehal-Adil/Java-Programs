...
sum of elements at indices [(i + 1) to (N-1)].
...
Hence index 2 is an equilibrium index according to the condition we want to achieve. Mind it that we haven't included the
item at index 2, which is 10, to either of the parts.
...
public class arrayEquilibriumIndex {
    ...
    // it won't make any sense for beginners
