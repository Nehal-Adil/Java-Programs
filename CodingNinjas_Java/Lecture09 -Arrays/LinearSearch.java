...
You have been given a random integer array/list(ARR) of size N, and an integer X. You need to search for the integer X in the given array/list using 'Linear Search'.
 You have been required to return the index at which X is present in the array/list. If X has multiple occurrences in the array/list, then you need to return the index at which the first occurrence of X would be encountered.
...
public class LinearSearch {
    ...
    public static void main(String[] args) {
        ...
        while (t > 0) {
            ...
            int val = sr.nextInt();
            System.out.println(LinearSearch.findItem(input, val));
            t -= 1;
        }
    }
}
